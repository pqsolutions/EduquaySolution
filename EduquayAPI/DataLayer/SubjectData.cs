        ...
        public void SubjectParent(SubjectParentDetailRequest spaData, int subID)
        {
            ...
            try
            {
                ...
                var pList = new List<SqlParameter>()
                {
                    ...
                    new SqlParameter("@Mother_UniquetID", spaData.Mother_UniquetID ?? spaData.Mother_UniquetID),
                    ...
                    new SqlParameter("@Father_UniquetID", spaData.Father_UniquetID ?? spaData.Father_UniquetID),
                    ...
                    new SqlParameter("@SchoolState", spaData.SchoolState),
